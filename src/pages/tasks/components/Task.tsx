          ...
          >
              <div className="flex justify-between items-center" >
                  <h3 
                    ...
                    className="font-semibold text-gray-900 text-[16px]">{task.title}</h3>
                  <Image 
              ...
              <p className="text-[11.5px] text-gray-500">Due Date: {task.dueDate}</p>
          </div>
        )}
      </Draggable>
        ...
        <div className='bg-white lg:w-[30%] w-[80%] mt-[13rem] p-5 mx-auto rounded-md'>
            ...
            <div className='flex justify-between mt-7'>
              <div className='flex gap-x-3'>
                <button onClick={handleEdit} className='px-[20px] text-[13px] py-2 border border-black text-black bg-white rounded-md'>Edit</button>
                <button onClick={handleDelete} className='px-[15px] text-[13px] py-2 border border-red-700 bg-red-700 text-white rounded-md'>Delete</button>
              </div>
